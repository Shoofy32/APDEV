import {showSearchResults} from "../search/searchresults.js"; // Import showSearchResults function
...
function searchPost(searchElement, event){
    ...
    if(event.key == "Enter" && (searchContent.length >= 3 || searchContent.length == 0)){
        ...
        if(window.location.pathname != "/search/searchresults.html"){

            window.location.href = "../search/searchresults.html";

            window.open("../search/searchresults.html", "_self");
